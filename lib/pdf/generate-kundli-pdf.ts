...
export function generateKundliPDF(data: KundliPDFData): void {
  ...
  doc.text("Generated by VedicAstro", pageWidth / 2, 32, { align: "center" })
  doc.setTextColor(0, 0, 0)
  yPos = 55
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.text(
      `Page ${i} of ${pageCount} | Generated on ${new Date().toLocaleDateString()} | VedicAstro.com`,
      pageWidth / 2,
